<!-- Shared site footer. Markup matches the old static footer exactly;
     the copyright year used to be set by js/script.js on page load — now
     it's just a computed value, which is simpler and always up to date. -->
